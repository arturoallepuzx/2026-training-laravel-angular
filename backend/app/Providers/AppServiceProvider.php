...
use App\Product\Infrastructure\Services\EloquentProductFamilyExistsChecker;
use App\Product\Infrastructure\Services\EloquentProductTaxExistsChecker;
...
use App\Table\Infrastructure\Services\EloquentTableZoneExistsChecker;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(TableZoneExistsCheckerInterface::class, EloquentTableZoneExistsChecker::class);
