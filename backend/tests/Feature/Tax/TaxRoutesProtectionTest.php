...
class TaxRoutesProtectionTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_get_all_returns_401_without_token(): void
    {
        ...
        $response = $this->getJson("/api/restaurants/{$restaurant->uuid}/taxes");
    ...
    public function test_get_all_returns_401_when_token_is_for_different_restaurant(): void
    {
        ...
        $response = $this->getJson(
            "/api/restaurants/{$restaurantB->uuid}/taxes",
            ['Authorization' => 'Bearer '.$token],
        );
    ...
    public function test_put_returns_403_with_operator_token(): void
    {
        ...
        $response = $this->putJson(
            "/api/restaurants/{$restaurant->uuid}/taxes/".Uuid::generate()->value(),
            ['name' => 'IVA', 'percentage' => 10],
            ['Authorization' => 'Bearer '.$token],
        );
