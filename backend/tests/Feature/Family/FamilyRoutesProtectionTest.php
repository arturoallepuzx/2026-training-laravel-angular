...
class FamilyRoutesProtectionTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_get_all_returns_401_without_token(): void
    {
        ...
        $response = $this->getJson("/api/restaurants/{$restaurant->uuid}/families");
    ...
    public function test_get_all_returns_401_when_token_is_for_different_restaurant(): void
    {
        ...
        $response = $this->getJson(
            "/api/restaurants/{$restaurantB->uuid}/families",
            ['Authorization' => 'Bearer '.$token],
        );
    ...
    public function test_put_returns_403_with_operator_token(): void
    {
        ...
        $response = $this->putJson(
            "/api/restaurants/{$restaurant->uuid}/families/".Uuid::generate()->value(),
            ['name' => 'Bebidas'],
            ['Authorization' => 'Bearer '.$token],
        );
